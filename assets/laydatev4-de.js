...
!(function (window, document) {
  ...
  Class.prototype.render = function () {
    var that = this,
      ...
      //主面板
      //改-外部
      elemPopup = (that.elemPopup = lay.elem("div", {
        class: "booking-popup",
      })),
      ...
      divCloseBtn = (that.closeBtn = lay.elem("i", {
  ...
  Class.prototype.next = function () {
    ...
    //预约成功
      ...
      lay(divBookingSusscessContent).html('<div class="shop-detail"></div>').html($('.shop-detail').html())
